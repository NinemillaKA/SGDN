...
use common\models\GlbGeografia;
use common\models\SgdnPrContactoTp;
use common\models\SgdnPrEstadoCivil;
use common\models\SgdnPrDocumentoTp;
use dosamigos\datepicker\DatePicker;
use wbraganca\dynamicform\DynamicFormWidget;


/* @var $this yii\web\View */
/* @var $model commom\models\sgdnPessoa */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sgdn-pessoa-form">

    <?php $form = ActiveForm::begin(['id' => 'sgdn-pessoa-form']); ?>
