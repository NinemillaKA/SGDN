...
/* @var $searchModel backend\models\SgdnRelResponsavelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sgdn Rel Responsavels';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgdn-rel-responsavel-index">

  <div class="box box-widget">
      <div class="box-header with-border">
              <?= Html::button('Registar', ['onclick' => 'create("sgdn-rel-responsavel/create")', 'class' => 'pull-right btn btn-flat btn-primary']) ?>
      </div>
      <div class="box-body">
          <?= GridView::widget([
