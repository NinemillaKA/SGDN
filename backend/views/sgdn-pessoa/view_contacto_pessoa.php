                                      ...
                                      echo '<li class="item">
                                              ...
                                              <div class="product-info">
                                                ...
                                                <span class="product-description">
                                                    Visualizar: '.Html::a('<i class="fa fa-eye"></i> ', ['/sgdn-pessoa/sample-display','filename'=>$documento->URL_DOCUMENTO], ['class' => '', 'target' =>'_blank'])
                                                    .' Download: ' .Html::a('<i class="fa fa-download"></i>', ['/sgdn-pessoa/sample-download','filename'=>$documento->URL_DOCUMENTO], ['class' => ''])
                                                .'</span>
                                              </div>
                                            </li>';
                                       ...
                                       echo '<li class="item">
                                               ...
                                               <div class="product-info">
                                                 <a href="javascript:void(0)" class="product-title">Certificado de Nascminto </a>
                                                 <span class="product-description">
                                                     Visualizar: '.Html::a('<i class="fa fa-eye"></i>', ['sample-display','filename'=>$documento->URL_DOCUMENTO], ['class' => ''])
                                                     .' Download: ' .Html::a('<i class="fa fa-download"></i>', ['sample-download','filename'=>$documento->URL_DOCUMENTO], ['class' => '',  'target' =>"_blank"])
                                                 .'</span>
                                               </div>
                                             </li>';
                                 }
