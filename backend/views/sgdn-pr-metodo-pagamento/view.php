...
?><?php
  Modal::begin([
    ...
    'footer' =>  Html::button('Close', ['onclick' => '$("#sgdn-pr-metodo-pagamento-form").submit();', 'class' => 'btn btn-flat btn-danger', 'data-dismiss'=>'modal']),
  ]);
?>
<div class="sgdn-pr-metodo-pagamento-view">
